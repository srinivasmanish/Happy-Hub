...
import { useCart } from '../Cart/Cart'; // Adjust path as needed
import candlelightData from './candlelightData'; // Adjust path as needed
...
function Candlelight() {
  ...
  return (
    <div>
      <h2 className="title">Candlelight Experiences</h2>
      <div className="card-container">
        {candlelightData.map((item, idx) => (
